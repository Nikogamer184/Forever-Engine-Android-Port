...
class ClassHUD extends FlxTypedGroup<FlxBasic>
{
	...
	public function new()
	{
		...
		healthBar.createFilledBar(FlxColor.fromRGB(PlayState.dadOpponent.healthColor.red, PlayState.dadOpponent.healthColor.green, PlayState.dadOpponent.healthColor.blue), 0xFF66FF33);
		// healthBar
		add(healthBar);
