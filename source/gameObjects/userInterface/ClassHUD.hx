...
class ClassHUD extends FlxTypedGroup<FlxBasic>
{
	...
	public function new()
	{
		...
		healthBar.createFilledBar(FlxColor.fromRGB(PlayState.instance.dadOpponent.healthColor.red, PlayState.instance.dadOpponent.healthColor.green, PlayState.instance.dadOpponent.healthColor.blue), 0xFF66FF33);
		// healthBar
		add(healthBar);
