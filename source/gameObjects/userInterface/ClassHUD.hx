...
class ClassHUD extends FlxTypedGroup<FlxBasic>
{
	...
	public function new()
	{
		...
		healthBar.createFilledBar(FlxColor.fromRGB(PlayState.instance.dadOpponent.healthColor.red, PlayState.instance.dadOpponent.healthColor.blue, PlayState.instance.dadOpponent.healthColor.green), 0xFF66FF33);
		// healthBar
		add(healthBar);
